...
if __name__ == '__main__':
  ...
  MEDIA_FOLDER_PATH = raw_input('Enter VIDEOS FOLDER PATH you wish to upload.\nGoto drive,MyDrive, Select the folder with the video/s inside.\nNOTE: this will not work on individual files. Create a single folder\nand put one video if you only want to upload one video:\n')
